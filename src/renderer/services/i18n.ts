...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    workbenchMaterialBasket: '材料篮',
    workbenchMaterialDropTitle: '把文件拖到这里',
    workbenchMaterialDropDescription: '支持文档、表格、图片和网页资料',
    workbenchArtifactLibrary: '产物库',
    workbenchRecentTasks: '最近任务',
    workbenchBasket: '工作篮',
    workbenchCloseBasket: '关闭工作篮',
  ...
  en: {
    ...
    workbenchMaterialBasket: 'Material basket',
    workbenchMaterialDropTitle: 'Drop files here',
    workbenchMaterialDropDescription: 'Works with docs, sheets, images, and web references',
    workbenchArtifactLibrary: 'Deliverable library',
    workbenchRecentTasks: 'Recent tasks',
    workbenchBasket: 'Work basket',
    workbenchCloseBasket: 'Close work basket',
