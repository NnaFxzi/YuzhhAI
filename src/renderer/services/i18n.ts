...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    enterpriseLeadCreateModeMaterialDesc: '选择客户资料、产品说明或聊天记录，统一加入空间知识库。',
    ...
    enterpriseLeadCreateMaterialSubtitle: '为「{name}」选择第一批资料文档。',
    enterpriseLeadCreateMaterialDropTitle: '选择资料文件',
    ...
    enterpriseLeadCreateMaterialFooterHint:
      '创建后资料会统一加入知识库并在本机后台解析；AI 知识需单独提取和确认。',
    ...
    enterpriseLeadMaterialRemoveFile: '移除 {name}',
    ...
    enterpriseLeadWorkbenchNavWorkflow: '推广工作流',
    ...
    enterpriseLeadWorkflowTitle: '推广执行台',
    enterpriseLeadWorkflowReadiness: '当前资料：{count} 项',
    enterpriseLeadWorkflowAgentCount: '已启用 Agent：{count}',
    enterpriseLeadWorkflowRunnableNodes: '可运行节点：{count}',
    enterpriseLeadWorkflowMissingPrerequisite: '缺少初始资料，建议先补充资料后再启动。',
    enterpriseLeadWorkflowGoal: '本次推广目标',
    enterpriseLeadWorkflowGoalPlaceholder: '描述本次推广要达成的业务目标',
    enterpriseLeadWorkflowModeCore: '核心推广流程',
    enterpriseLeadWorkflowModeCoreDescription: '执行当前支持的核心推广节点。',
    enterpriseLeadWorkflowModeFull: '完整推广闭环',
    enterpriseLeadWorkflowModeFullDescription: '额外启用销售交接、账号监控和效果复盘节点。',
    enterpriseLeadWorkflowDraftOnlyNotice: '仅生成草稿；发布与外部触达仍需人工确认。',
    enterpriseLeadWorkflowStart: '启动工作流',
    enterpriseLeadWorkflowOpenCowork: '打开 Cowork 对话',
    enterpriseLeadWorkflowLoadFailed: '无法恢复工作流快照。',
    enterpriseLeadWorkflowStartFailed: '工作流启动失败，请稍后重试。',
    enterpriseLeadWorkflowActionFailed: '工作流操作失败，请稍后重试。',
    enterpriseLeadWorkflowResume: '恢复',
    enterpriseLeadWorkflowCancel: '取消',
    enterpriseLeadWorkflowRetry: '重试',
    enterpriseLeadWorkflowSummaryDraft: '工作流草稿已创建，等待启动。',
    enterpriseLeadWorkflowSummaryRunning: '推广工作流正在处理任务。',
    enterpriseLeadWorkflowSummaryNeedsInput: '工作流需要补充信息后才能继续。',
    enterpriseLeadWorkflowSummaryAwaitingApproval: '工作流正在等待人工审批。',
    enterpriseLeadWorkflowSummaryManualAttention: '工作流需要人工处理。',
    enterpriseLeadWorkflowSummaryBlocked: '工作流受阻，等待人工处理。',
    enterpriseLeadWorkflowSummaryCompleted: '推广工作流已完成，结果仅为草稿。',
    enterpriseLeadWorkflowSummaryCancelled: '工作流已取消。',
    enterpriseLeadWorkflowSummaryArchived: '工作流已归档，只读。',
    enterpriseLeadWorkflowSummaryError: '工作流执行出错，可重试。',
    enterpriseLeadWorkflowArtifactCount: '成果 {count}',
    enterpriseLeadWorkflowRiskCount: '风险 {count}',
    enterpriseLeadWorkflowTodoCount: '待办 {count}',
    enterpriseLeadWorkflowAttempts: '尝试 {count}',
    enterpriseLeadWorkflowDurationUnknown: '耗时未知',
    enterpriseLeadWorkflowDurationMinutes: '约 {count} 分钟',
    enterpriseLeadWorkflowInputArtifacts: '输入成果',
    enterpriseLeadWorkflowOutputArtifacts: '输出成果',
    enterpriseLeadWorkflowOpenChildSession: '查看子会话',
    enterpriseLeadWorkflowApprovalTitle: '等待人工审批',
    enterpriseLeadWorkflowApprovalFeedbackPlaceholder: '填写退回修改意见',
    enterpriseLeadWorkflowApprove: '批准并标记人工处理完成',
    enterpriseLeadWorkflowReject: '退回修改',
    enterpriseLeadWorkflowEventSummary: '最新事件',
    enterpriseLeadWorkflowEventUpdate: '工作流状态已更新。',
    enterpriseLeadWorkflowEventRunStarted: '工作流已启动',
    enterpriseLeadWorkflowEventRunRetrying: '工作流正在重试',
    enterpriseLeadWorkflowEventTaskReady: '任务已就绪',
    enterpriseLeadWorkflowEventTaskStarted: '任务已开始',
    enterpriseLeadWorkflowEventTaskRetrying: '任务正在重试',
    enterpriseLeadWorkflowEventTaskCompleted: '任务已完成',
    enterpriseLeadWorkflowEventTaskFailed: '任务失败',
    enterpriseLeadWorkflowEventTaskBlocked: '任务被阻塞',
    enterpriseLeadWorkflowEventTaskCancelled: '任务已取消',
    enterpriseLeadWorkflowEventApprovalRequired: '等待人工审批',
    enterpriseLeadWorkflowEventApprovalRejected: '审批已退回修改',
    enterpriseLeadWorkflowEventRunCompleted: '工作流已完成',
    enterpriseLeadWorkflowEventRunCancelled: '工作流已取消',
    enterpriseLeadWorkflowEventRunError: '工作流发生错误',
    enterpriseLeadWorkflowEventUnknown: '工作流状态已更新',
    enterpriseLeadWorkflowHistoryDag: '工作流 DAG 与成果来源',
    enterpriseLeadWorkflowHistoryReadOnly: '已归档，只读',
    enterpriseLeadWorkflowHistoryTimeline: '工作流历史',
    enterpriseLeadWorkflowHistoryEvent: '事件：{event}',
    enterpriseLeadWorkflowHistoryFeedback: '修改意见：{feedback}',
    enterpriseLeadWorkflowHistoryAttempt: '第 {count} 次尝试：{status}',
    enterpriseLeadWorkflowArtifactVersion: '版本 {version} · 来源 {source}',
    enterpriseLeadWorkflowMonitoringTitle: '账户监控与效果复盘',
    enterpriseLeadWorkflowMonitoringPending: '账户监控等待可验证的指标输入。',
    enterpriseLeadWorkflowMonitoringNeedsInput: '账户监控缺少已验证的平台、来源或时间范围。',
    enterpriseLeadWorkflowMonitoringReviewBlocked: '缺少已验证的账户指标，效果复盘暂不能继续。',
    enterpriseLeadWorkflowMonitoringReportReady: '账户指标报告已生成，可作为复盘输入。',
    enterpriseLeadWorkflowReviewPending: '效果复盘等待账户指标报告。',
    enterpriseLeadWorkflowReviewReady: '效果复盘和下一轮建议已生成。',
    enterpriseLeadWorkflowReviewAwaitingConfirmation: '效果复盘已生成，等待您确认是否写入长期知识。',
    enterpriseLeadWorkflowReviewKnowledgeConfirmation:
      '复盘结论需要人工确认后才能写入工作空间长期知识。',
    enterpriseLeadWorkflowMonitoringReasonMetricSnapshot: '请提供可验证的账户指标快照。',
    enterpriseLeadWorkflowMonitoringReasonMetricPlatform: '请确认指标所属的平台。',
    enterpriseLeadWorkflowMonitoringReasonMetricSource: '请提供指标数据来源。',
    enterpriseLeadWorkflowMonitoringReasonMetricPeriod: '请提供有效的指标统计时间范围。',
    enterpriseLeadWorkflowMonitoringReasonIdempotencyKey: '请提供本次监控的唯一标识。',
    enterpriseLeadWorkflowMonitoringReasonWorkspace: '请确认监控所属工作区。',
    enterpriseLeadWorkflowMonitoringReasonRun: '请确认监控所属工作流运行。',
    enterpriseLeadWorkflowMonitoringReasonMonitoringAgent: '请确认负责监控的 Agent。',
    enterpriseLeadWorkflowMonitoringReasonGeneric: '请补充可验证的监控信息后重试。',
    ...
    enterpriseKnowledgeUploadFiles: '上传文件',
    enterpriseKnowledgeActiveDocuments: '当前文档',
    enterpriseKnowledgeDeletedDocuments: '回收站',
    enterpriseKnowledgeDeleteDocument: '删除文档',
    enterpriseKnowledgeRestoreDocument: '恢复文档',
    enterpriseKnowledgeRetryDocument: '重试处理',
    ...
    enterpriseKnowledgeDocumentStatusPending: '等待处理',
    enterpriseKnowledgeDocumentStatusProcessing: '处理中',
    enterpriseKnowledgeDocumentStatusReady: '本地处理完成',
    enterpriseKnowledgeDocumentStatusSavedNotSearchable: '已保存，但不可搜索',
    enterpriseKnowledgeDocumentStatusFailed: '处理失败',
    enterpriseKnowledgeDocumentStatusDeleted: '已删除',
    enterpriseKnowledgeImportSuccess: '已导入 {imported} 个文档',
    enterpriseKnowledgeImportPartialSuccess: '已导入 {imported} 个文档，{failed} 个失败',
    enterpriseKnowledgeImportFailed: '文档导入失败',
    enterpriseKnowledgeImportFailuresTitle: '未导入的文件',
    enterpriseKnowledgeRevisionConflict: '文档已在其他操作中更新，请刷新后重试。',
    enterpriseKnowledgeSelectionUnavailable: '文件选择功能暂不可用。',
    enterpriseKnowledgeErrorInvalidSelection: '文件选择已失效，请重新选择。',
    enterpriseKnowledgeErrorTooManyFiles: '一次最多选择 100 个文件。',
    enterpriseKnowledgeErrorFileTooLarge: '文件超过 50 MiB 限制。',
    enterpriseKnowledgeErrorUnsupportedType: '文件格式或文件内容不受支持。',
    enterpriseKnowledgeErrorFileChanged: '文件已移动或发生变化，请重新选择。',
    enterpriseKnowledgeErrorQuotaExceeded: '当前工作空间已达到 20 GiB 文档配额。',
    enterpriseKnowledgeErrorPersistence: '知识库操作失败，请重试。',
    enterpriseKnowledgeDocumentsTitle: '资料文档',
    enterpriseKnowledgeDocumentsSubtitle:
      '所有入口上传的资料都统一加入当前空间知识库，在本机安全存储和处理。',
    enterpriseKnowledgeFileListTitle: '文件列表',
    enterpriseKnowledgeFileCount: '共 {count} 个文件',
    enterpriseKnowledgeStatusFilter: '文档状态筛选',
    enterpriseKnowledgeStatusAll: '全部状态',
    enterpriseKnowledgeFileSizeUnknown: '大小未知',
    enterpriseKnowledgeFileTypeUnknown: '未知类型',
    enterpriseKnowledgeUnknownTime: '时间未知',
    enterpriseKnowledgeStageQueued: '等待处理',
    enterpriseKnowledgeStageParsing: '解析文档',
    enterpriseKnowledgeStageOcr: '文字识别',
    enterpriseKnowledgeStageChunking: '整理内容',
    enterpriseKnowledgeStageIndexing: '建立索引',
    enterpriseKnowledgeStageFactExtraction: '提取知识',
    enterpriseKnowledgeProgress: '进度 {progress}%',
    enterpriseKnowledgeProcessingProgress: '文档处理进度',
    enterpriseKnowledgeLoadingDocuments: '正在加载文档…',
    enterpriseKnowledgeLoadingDetails: '正在加载文档详情…',
    enterpriseKnowledgeNoDocuments: '暂无文档，上传文件后即可开始本地处理。',
    enterpriseKnowledgeNoDeletedDocuments: '回收站中暂无文档。',
    enterpriseKnowledgeDocumentDetails: '按需加载的本地提取内容',
    enterpriseKnowledgeCloseDetails: '关闭文档详情',
    enterpriseKnowledgeDocumentTextEmpty: '该文档没有可展示的提取文本。',
    enterpriseKnowledgeDeleteConfirm: '删除这个文档？',
    enterpriseKnowledgeDeleteConfirmMessage: '“{name}”将移入回收站，之后仍可恢复。',
    enterpriseKnowledgeCancel: '取消',
    enterpriseKnowledgeAiExtraction: 'AI 知识提取',
    enterpriseKnowledgeAiExtractionStatusCancelled: '已取消',
    enterpriseKnowledgeAiExtractionStatusCompleted: '提取完成',
    enterpriseKnowledgeAiExtractionStatusFailed: '提取失败',
    enterpriseKnowledgeAiExtractionStatusNotStarted: '尚未提取',
    enterpriseKnowledgeAiExtractionStatusQueued: '等待提取',
    enterpriseKnowledgeAiExtractionStatusReviewRequired: '等待审核',
    enterpriseKnowledgeAiExtractionStatusRunning: '提取中',
    enterpriseKnowledgeAiExtractionStatusStale: '结果已过期',
    enterpriseKnowledgeAiExtractionStatusStalePriorVersion: '旧版本已有提取结果',
    enterpriseKnowledgeAiExtractionQueuedDescription: '已加入本机处理队列',
    enterpriseKnowledgeAiExtractionRunningTitle: '正在提取 AI 知识',
    enterpriseKnowledgeAiExtractionRunningDescription:
      '正在分析文档内容并整理事实、规则和卖点',
    enterpriseKnowledgeAiExtractionReviewSummary:
      '已提取 {pendingFactCount} 条知识，等待确认',
    enterpriseKnowledgeCancelAiExtraction: '取消提取',
    enterpriseKnowledgeExtractAiKnowledge: '提取 AI 知识',
    enterpriseKnowledgeExtractCurrentVersion: '提取当前版本',
    enterpriseKnowledgeExtractionAuthorizationDescription: '本操作会将文档内容发送给所选 AI 服务进行知识提取，请确认发送范围。',
    enterpriseKnowledgeExtractionAuthorizationDocument: '文档',
    enterpriseKnowledgeExtractionAuthorizationExpiresAt: '授权有效期至',
    enterpriseKnowledgeExtractionAuthorizationModel: '模型',
    enterpriseKnowledgeExtractionAuthorizationPartialWarning: '本次请求可能只处理部分内容，请确认后发送。',
    enterpriseKnowledgeExtractionAuthorizationPlannedCalls: '预计调用次数',
    enterpriseKnowledgeExtractionAuthorizationPreparing: '正在准备提取授权…',
    enterpriseKnowledgeExtractionAuthorizationProvider: '服务提供商',
    enterpriseKnowledgeExtractionAuthorizationSend: '确认并发送',
    enterpriseKnowledgeExtractionAuthorizationSending: '正在发送…',
    enterpriseKnowledgeExtractionAuthorizationTitle: '授权 AI 知识提取',
    enterpriseKnowledgeRetryAiExtraction: '重试提取',
    enterpriseAiKnowledgeColumnActions: '操作',
    enterpriseAiKnowledgeColumnDomain: '知识分类',
    enterpriseAiKnowledgeColumnEvidence: '证据',
    enterpriseAiKnowledgeColumnSource: '来源',
    enterpriseAiKnowledgeColumnStatus: '状态',
    enterpriseAiKnowledgeColumnValue: '知识内容',
    enterpriseAiKnowledgeContentCollapse: '收起内容',
    enterpriseAiKnowledgeContentExpand: '展开内容',
    enterpriseAiKnowledgeDomainApplicationScenarios: '应用场景',
    enterpriseAiKnowledgeDomainChannelPreferences: '渠道偏好',
    enterpriseAiKnowledgeDomainCompanySummary: '企业概况',
    enterpriseAiKnowledgeDomainContactRules: '联系规则',
    enterpriseAiKnowledgeDomainMissingInfo: '待补充信息',
    enterpriseAiKnowledgeDomainProductCapabilities: '产品能力',
    enterpriseAiKnowledgeDomainProductList: '产品列表',
    enterpriseAiKnowledgeDomainProhibitedClaims: '禁用表述',
    enterpriseAiKnowledgeDomainSellingPoints: '核心卖点',
    enterpriseAiKnowledgeDomainTargetCustomers: '目标客户',
    enterpriseAiKnowledgeEmptyActive: '暂无可用的 AI 知识。',
    enterpriseAiKnowledgeEmptyHistory: '暂无历史 AI 知识。',
    enterpriseAiKnowledgeEndOfList: '已显示全部知识',
    enterpriseAiKnowledgeEvidenceActive: '有效证据',
    enterpriseAiKnowledgeEvidenceAny: '全部证据',
    enterpriseAiKnowledgeEvidenceFilterLabel: '证据状态',
    enterpriseAiKnowledgeEvidenceStale: '失效证据',
    enterpriseAiKnowledgeLegacyNoEvidence: '无独立证据',
    enterpriseAiKnowledgeLegacyReadOnly: '只读',
    enterpriseAiKnowledgeLegacySource: '公司资料',
    enterpriseAiKnowledgeLoadFailed: 'AI 知识加载失败。',
    enterpriseAiKnowledgeLoadMore: '加载更多',
    enterpriseAiKnowledgeLoading: '正在加载 AI 知识…',
    enterpriseAiKnowledgeLoadingMore: '正在加载更多…',
    enterpriseAiKnowledgeLoadingStatus: 'AI 知识加载状态',
    enterpriseAiKnowledgeMaintainCompany: '维护公司资料',
    enterpriseAiKnowledgePartialLoadFailed: '部分知识加载失败，当前结果仍可查看。',
    enterpriseAiKnowledgeRetryInitial: '重新加载',
    enterpriseAiKnowledgeRetryPartial: '重试失败部分',
    enterpriseAiKnowledgeReviewFilterAll: '全部状态',
    enterpriseAiKnowledgeReviewFilterLabel: '审核状态',
    enterpriseAiKnowledgeSourceExtracted: 'AI 提取',
    enterpriseAiKnowledgeSourceImported: '导入',
    enterpriseAiKnowledgeSourceManual: '手动录入',
    enterpriseAiKnowledgeStatusArchived: '已归档',
    enterpriseAiKnowledgeStatusConfirmed: '已确认',
    enterpriseAiKnowledgeStatusPending: '待确认',
    enterpriseAiKnowledgeStatusRejected: '已拒绝',
    enterpriseAiKnowledgeTableCaption: 'AI 知识列表',
    enterpriseAiKnowledgeViewActive: '当前知识',
    enterpriseAiKnowledgeViewHistory: '历史记录',
    enterpriseAiKnowledgeViewLabel: '知识视图',
    enterpriseAiKnowledgeArchive: '归档',
    enterpriseAiKnowledgeArchiveConflictDescription: '公司资料中的对应内容已发生变化，请选择如何处理当前内容。',
    enterpriseAiKnowledgeArchiveConflictTitle: '归档内容存在冲突',
    enterpriseAiKnowledgeArchiveKeepCurrent: '保留当前公司资料',
    enterpriseAiKnowledgeArchiveLedgerlessDescription: '未找到可核对的历史记录，只能保留公司资料中的当前内容。',
    enterpriseAiKnowledgeArchiveRemoveCurrent: '同时移除当前内容',
    enterpriseAiKnowledgeCompanyConflictDescription: '公司资料已有不同内容。确认后将用这条知识替换现有内容。',
    enterpriseAiKnowledgeCompanyConflictTitle: '确认替换公司资料',
    enterpriseAiKnowledgeCompanyReplace: '替换现有内容',
    enterpriseAiKnowledgeConfirm: '确认',
    enterpriseAiKnowledgeConfirmRequiresActiveEvidence: '仅有有效证据的知识可以确认。',
    enterpriseAiKnowledgeDialogCancel: '取消',
    enterpriseAiKnowledgeEvidenceActiveState: '有效',
    enterpriseAiKnowledgeEvidenceCollapse: '收起证据',
    enterpriseAiKnowledgeEvidenceConfidence: '可信度',
    enterpriseAiKnowledgeEvidenceDrawerClose: '关闭证据抽屉',
    enterpriseAiKnowledgeEvidenceEmpty: '暂无可查看的证据。',
    enterpriseAiKnowledgeEvidenceEnd: '已显示全部证据',
    enterpriseAiKnowledgeEvidenceExpand: '查看证据',
    enterpriseAiKnowledgeEvidenceLoadFailed: '证据加载失败。',
    enterpriseAiKnowledgeEvidenceLoadMore: '加载更多证据',
    enterpriseAiKnowledgeEvidenceLoading: '正在加载证据…',
    enterpriseAiKnowledgeEvidenceLoadingMore: '正在加载更多证据…',
    enterpriseAiKnowledgeEvidenceLoadingStatus: '证据加载状态',
    enterpriseAiKnowledgeEvidencePreview: '证据摘录',
    enterpriseAiKnowledgeEvidenceRetry: '重试加载证据',
    enterpriseAiKnowledgeEvidenceStaleState: '已失效',
    enterpriseAiKnowledgeEvidenceStateConflict: '证据状态已变化，知识列表已刷新。',
    enterpriseAiKnowledgeEvidenceUnknownTime: '时间未知',
    enterpriseAiKnowledgeMutationDisabledReason: '当前状态下无法执行此操作。',
    enterpriseAiKnowledgeMutationFailed: '操作失败，请重试。',
    enterpriseAiKnowledgeMutationLiveStatus: 'AI 知识操作状态',
    enterpriseAiKnowledgeMutationStale: '知识已发生变化，请基于最新内容重试。',
    enterpriseAiKnowledgeMutationSubmitting: '正在提交…',
    enterpriseAiKnowledgeMutationSucceeded: '操作已完成。',
    enterpriseAiKnowledgePanelFocusAnchor: 'AI 知识列表焦点位置',
    enterpriseAiKnowledgeReject: '拒绝',
    enterpriseAiKnowledgeBatchSelectedCount: '已选 {count} 条',
    enterpriseAiKnowledgeBatchMatchingSelectionSummary: '已选择全部匹配结果',
    enterpriseAiKnowledgeBatchMatchingSelectionHint: '最终数量将在任务开始后显示。',
    enterpriseAiKnowledgeBatchToggleVisibleLabel: '选择当前可见的待审核知识',
    enterpriseAiKnowledgeBatchSelectAllMatchingPrompt: '当前页已选中，可继续扩展到全部匹配筛选条件的知识。',
    enterpriseAiKnowledgeBatchSelectAllMatchingAction: '选择全部匹配筛选条件',
    enterpriseAiKnowledgeBatchSelectAllPendingAction: '选择全部待确认知识',
    enterpriseAiKnowledgeBatchConfirmAction: '批量确认 {count} 条',
    enterpriseAiKnowledgeBatchConfirmMatchingAction: '批量确认全部匹配结果',
    enterpriseAiKnowledgeBatchRejectAction: '批量拒绝 {count} 条',
    enterpriseAiKnowledgeBatchRejectMatchingAction: '批量拒绝全部匹配结果',
    enterpriseAiKnowledgeBatchArchiveAction: '批量归档 {count} 条',
    enterpriseAiKnowledgeBatchArchiveMatchingAction: '批量归档全部匹配结果',
    enterpriseAiKnowledgeBatchClearSelection: '清除选择',
    enterpriseAiKnowledgeBatchConfirmTitle: '批量确认 {count} 条知识',
    enterpriseAiKnowledgeBatchConfirmMatchingTitle: '批量确认全部匹配结果',
    enterpriseAiKnowledgeBatchConfirmDescription:
      '只会处理证据仍然有效且没有冲突的知识；无效证据、版本已变化或存在冲突的条目会被跳过。',
    enterpriseAiKnowledgeBatchConfirmMatchingDescription:
      '此任务会处理当前筛选条件下的全部匹配知识；最终数量将在任务开始后显示。只会处理证据仍然有效且没有冲突的条目。',
    enterpriseAiKnowledgeBatchRejectTitle: '批量拒绝 {count} 条知识',
    enterpriseAiKnowledgeBatchRejectMatchingTitle: '批量拒绝全部匹配结果',
    enterpriseAiKnowledgeBatchRejectDescription:
      '为这批知识填写统一拒绝原因。已被其他变更处理的条目会在结果中单独标记。',
    enterpriseAiKnowledgeBatchRejectMatchingDescription:
      '此任务会处理当前筛选条件下的全部匹配知识；最终数量将在任务开始后显示。请为这批知识填写统一拒绝原因。',
    enterpriseAiKnowledgeBatchArchiveTitle: '批量归档 {count} 条知识',
    enterpriseAiKnowledgeBatchArchiveMatchingTitle: '批量归档全部匹配结果',
    enterpriseAiKnowledgeBatchArchiveDescription:
      '归档后这些知识不会继续出现在默认待处理列表中，结果会保留成功、跳过和失败摘要。',
    enterpriseAiKnowledgeBatchArchiveMatchingDescription:
      '此任务会处理当前筛选条件下的全部匹配知识；最终数量将在任务开始后显示。归档后这些知识不会继续出现在默认待处理列表中。',
    enterpriseAiKnowledgeBatchRejectReasonLabel: '统一拒绝原因',
    enterpriseAiKnowledgeBatchRejectReasonPlaceholder: '说明这批知识为什么不应进入正式知识库。',
    enterpriseAiKnowledgeBatchRejectReasonRequired: '请输入非空的拒绝原因后再提交。',
    enterpriseAiKnowledgeBatchRejectReasonTooLong: '统一拒绝原因不能超过 {max} 个字符，请缩短后再提交。',
    enterpriseAiKnowledgeBatchSubmitConfirm: '确认这 {count} 条',
    enterpriseAiKnowledgeBatchSubmitConfirmMatching: '确认全部匹配结果',
    enterpriseAiKnowledgeBatchSubmitReject: '拒绝这 {count} 条',
    enterpriseAiKnowledgeBatchSubmitRejectMatching: '拒绝全部匹配结果',
    enterpriseAiKnowledgeBatchSubmitArchive: '归档这 {count} 条',
    enterpriseAiKnowledgeBatchSubmitArchiveMatching: '归档全部匹配结果',
    enterpriseAiKnowledgeBatchLiveStatus: '批量审核状态',
    enterpriseAiKnowledgeBatchSubmitting: '正在创建批量任务…',
    enterpriseAiKnowledgeBatchQueuedStatus: '已排队，准备处理 {processed}/{total}',
    enterpriseAiKnowledgeBatchRunningStatus: '正在处理 {processed}/{total}',
    enterpriseAiKnowledgeBatchCompletedTitle: '批量审核已完成',
    enterpriseAiKnowledgeBatchFailedTitle: '批量审核未完全完成',
    enterpriseAiKnowledgeBatchSuccessCount: '成功 {count}',
    enterpriseAiKnowledgeBatchSkippedCount: '跳过 {count}',
    enterpriseAiKnowledgeBatchFailedCount: '失败 {count}',
    enterpriseAiKnowledgeBatchDetailHeading: '结果明细示例',
    enterpriseAiKnowledgeBatchDetailNoActiveEvidence: '证据已失效，已跳过。',
    enterpriseAiKnowledgeBatchDetailRevisionConflict: '版本已变化，请按最新内容重试。',
    enterpriseAiKnowledgeBatchDetailProjectionConflict: '存在知识投影冲突，已跳过。',
    enterpriseAiKnowledgeBatchDetailAlreadyProcessed: '该条目已被其他操作处理。',
    enterpriseAiKnowledgeBatchDetailNotFound: '未找到对应知识条目。',
    enterpriseAiKnowledgeBatchDetailUnknownError: '处理失败，可稍后重试。',
    enterpriseAiKnowledgeBatchRetryFailed: '重试可重试项（{count}）',
    enterpriseAiKnowledgeBatchDismissResult: '关闭结果',
    ...
    enterpriseLeadKnowledgeKnowledgeSearchPlaceholder: '搜索知识、分类',
    ...
    enterpriseLeadCreationRunStatusAwaitingApproval: '待确认',
    enterpriseLeadCreationRunStatusBlocked: '已阻塞',
    enterpriseLeadCreationRunStatusCompleted: '已完成',
    enterpriseLeadCreationRunStatusCancelled: '已取消',
  ...
  en: {
    ...
    enterpriseLeadCreateModeMaterialDesc:
      'Select customer files, product notes, or chat records for the shared workspace knowledge base.',
    ...
    enterpriseLeadCreateMaterialSubtitle: 'Select the first source documents for "{name}".',
    enterpriseLeadCreateMaterialDropTitle: 'Choose material files',
    enterpriseLeadCreateMaterialDropDesc:
    ...
    enterpriseLeadCreateMaterialFooterHint:
      'After creation, documents join the same knowledge base and are processed locally. AI knowledge extraction and review are separate.',
    ...
    enterpriseLeadMaterialRemoveFile: 'Remove {name}',
    ...
    enterpriseLeadAgentStatusReady: 'Ready',
    ...
    enterpriseLeadWorkbenchNavWorkflow: 'Promotion workflow',
    ...
    enterpriseLeadWorkflowTitle: 'Promotion run workbench',
    enterpriseLeadWorkflowReadiness: 'Available material: {count}',
    enterpriseLeadWorkflowAgentCount: 'Enabled agents: {count}',
    enterpriseLeadWorkflowRunnableNodes: 'Runnable nodes: {count}',
    enterpriseLeadWorkflowMissingPrerequisite: 'Initial material is missing; add it before starting.',
    enterpriseLeadWorkflowGoal: 'Promotion goal',
    enterpriseLeadWorkflowGoalPlaceholder: 'Describe the business outcome for this promotion',
    enterpriseLeadWorkflowModeCore: 'Core promotion flow',
    enterpriseLeadWorkflowModeCoreDescription: 'Runs the currently supported core promotion nodes.',
    enterpriseLeadWorkflowModeFull: 'Full promotion loop',
    enterpriseLeadWorkflowModeFullDescription: 'Also enables sales handoff, account monitoring, and performance review nodes.',
    enterpriseLeadWorkflowDraftOnlyNotice: 'Drafts only; publishing and external outreach still require human confirmation.',
    enterpriseLeadWorkflowStart: 'Start workflow',
    enterpriseLeadWorkflowOpenCowork: 'Open Cowork chat',
    enterpriseLeadWorkflowLoadFailed: 'Unable to restore the workflow snapshot.',
    enterpriseLeadWorkflowStartFailed: 'Unable to start the workflow. Try again shortly.',
    enterpriseLeadWorkflowActionFailed: 'The workflow action failed. Try again shortly.',
    enterpriseLeadWorkflowResume: 'Resume',
    enterpriseLeadWorkflowCancel: 'Cancel',
    enterpriseLeadWorkflowRetry: 'Retry',
    enterpriseLeadWorkflowSummaryDraft: 'Workflow draft created and ready to start.',
    enterpriseLeadWorkflowSummaryRunning: 'Promotion workflow is processing tasks.',
    enterpriseLeadWorkflowSummaryNeedsInput: 'Workflow needs more information to continue.',
    enterpriseLeadWorkflowSummaryAwaitingApproval: 'Workflow is awaiting human approval.',
    enterpriseLeadWorkflowSummaryManualAttention: 'Workflow requires human attention.',
    enterpriseLeadWorkflowSummaryBlocked: 'Workflow is blocked and awaiting human attention.',
    enterpriseLeadWorkflowSummaryCompleted: 'Promotion workflow completed with draft-only outputs.',
    enterpriseLeadWorkflowSummaryCancelled: 'Workflow cancelled.',
    enterpriseLeadWorkflowSummaryArchived: 'Workflow archived and read-only.',
    enterpriseLeadWorkflowSummaryError: 'Workflow encountered an error and can be retried.',
    enterpriseLeadWorkflowArtifactCount: 'Artifacts {count}',
    enterpriseLeadWorkflowRiskCount: 'Risks {count}',
    enterpriseLeadWorkflowTodoCount: 'Todos {count}',
    enterpriseLeadWorkflowAttempts: 'Attempts {count}',
    enterpriseLeadWorkflowDurationUnknown: 'Duration unknown',
    enterpriseLeadWorkflowDurationMinutes: 'About {count} min',
    enterpriseLeadWorkflowInputArtifacts: 'Input artifacts',
    enterpriseLeadWorkflowOutputArtifacts: 'Output artifacts',
    enterpriseLeadWorkflowOpenChildSession: 'View child session',
    enterpriseLeadWorkflowApprovalTitle: 'Human approval required',
    enterpriseLeadWorkflowApprovalFeedbackPlaceholder: 'Add revision feedback',
    enterpriseLeadWorkflowApprove: 'Approve and mark manual handling complete',
    enterpriseLeadWorkflowReject: 'Return for revision',
    enterpriseLeadWorkflowEventSummary: 'Latest events',
    enterpriseLeadWorkflowEventUpdate: 'Workflow status updated.',
    enterpriseLeadWorkflowEventRunStarted: 'Workflow started',
    enterpriseLeadWorkflowEventRunRetrying: 'Workflow retrying',
    enterpriseLeadWorkflowEventTaskReady: 'Task ready',
    enterpriseLeadWorkflowEventTaskStarted: 'Task started',
    enterpriseLeadWorkflowEventTaskRetrying: 'Task retrying',
    enterpriseLeadWorkflowEventTaskCompleted: 'Task completed',
    enterpriseLeadWorkflowEventTaskFailed: 'Task failed',
    enterpriseLeadWorkflowEventTaskBlocked: 'Task blocked',
    enterpriseLeadWorkflowEventTaskCancelled: 'Task cancelled',
    enterpriseLeadWorkflowEventApprovalRequired: 'Human approval required',
    enterpriseLeadWorkflowEventApprovalRejected: 'Approval returned for revision',
    enterpriseLeadWorkflowEventRunCompleted: 'Workflow completed',
    enterpriseLeadWorkflowEventRunCancelled: 'Workflow cancelled',
    enterpriseLeadWorkflowEventRunError: 'Workflow error',
    enterpriseLeadWorkflowEventUnknown: 'Workflow status updated',
    enterpriseLeadWorkflowHistoryDag: 'Workflow DAG and artifact sources',
    enterpriseLeadWorkflowHistoryReadOnly: 'Archived, read-only',
    enterpriseLeadWorkflowHistoryTimeline: 'Workflow history',
    enterpriseLeadWorkflowHistoryEvent: 'Event: {event}',
    enterpriseLeadWorkflowHistoryFeedback: 'Feedback: {feedback}',
    enterpriseLeadWorkflowHistoryAttempt: 'Attempt {count}: {status}',
    enterpriseLeadWorkflowArtifactVersion: 'Version {version} · Source {source}',
    enterpriseLeadWorkflowMonitoringTitle: 'Account monitoring and performance review',
    enterpriseLeadWorkflowMonitoringPending: 'Account monitoring is waiting for verified metrics.',
    enterpriseLeadWorkflowMonitoringNeedsInput:
      'Account monitoring needs a verified platform, source, or time range.',
    enterpriseLeadWorkflowMonitoringReviewBlocked:
      'Performance review cannot continue until account metrics are verified.',
    enterpriseLeadWorkflowMonitoringReportReady:
      'The metric report is ready for performance review.',
    enterpriseLeadWorkflowReviewPending: 'Performance review is waiting for the metric report.',
    enterpriseLeadWorkflowReviewReady: 'Performance review and next-cycle recommendations are ready.',
    enterpriseLeadWorkflowReviewAwaitingConfirmation:
      'Performance review is ready and awaits your confirmation to save knowledge.',
    enterpriseLeadWorkflowReviewKnowledgeConfirmation:
      'Confirm review conclusions before they are saved to durable workspace knowledge.',
    enterpriseLeadWorkflowMonitoringReasonMetricSnapshot:
      'Provide a verifiable account-metrics snapshot.',
    enterpriseLeadWorkflowMonitoringReasonMetricPlatform: 'Confirm the metrics platform.',
    enterpriseLeadWorkflowMonitoringReasonMetricSource: 'Provide the metrics data source.',
    enterpriseLeadWorkflowMonitoringReasonMetricPeriod: 'Provide a valid metrics reporting period.',
    enterpriseLeadWorkflowMonitoringReasonIdempotencyKey: 'Provide a unique monitoring identifier.',
    enterpriseLeadWorkflowMonitoringReasonWorkspace: 'Confirm the monitoring workspace.',
    enterpriseLeadWorkflowMonitoringReasonRun: 'Confirm the workflow run for monitoring.',
    enterpriseLeadWorkflowMonitoringReasonMonitoringAgent: 'Confirm the monitoring agent.',
    enterpriseLeadWorkflowMonitoringReasonGeneric:
      'Provide verifiable monitoring information before trying again.',
    ...
    enterpriseKnowledgeUploadFiles: 'Upload files',
    enterpriseKnowledgeActiveDocuments: 'Current documents',
    enterpriseKnowledgeDeletedDocuments: 'Trash',
    enterpriseKnowledgeDeleteDocument: 'Delete document',
    enterpriseKnowledgeRestoreDocument: 'Restore document',
    enterpriseKnowledgeRetryDocument: 'Retry processing',
    ...
    enterpriseKnowledgeDocumentStatusPending: 'Waiting to process',
    enterpriseKnowledgeDocumentStatusProcessing: 'Processing',
    enterpriseKnowledgeDocumentStatusReady: 'Processed locally',
    enterpriseKnowledgeDocumentStatusSavedNotSearchable: 'Saved, not searchable',
    enterpriseKnowledgeDocumentStatusFailed: 'Processing failed',
    enterpriseKnowledgeDocumentStatusDeleted: 'Deleted',
    enterpriseKnowledgeImportSuccess: 'Imported {imported} document(s)',
    enterpriseKnowledgeImportPartialSuccess: 'Imported {imported} document(s); {failed} failed',
    enterpriseKnowledgeImportFailed: 'Document import failed',
    enterpriseKnowledgeImportFailuresTitle: 'Files not imported',
    enterpriseKnowledgeRevisionConflict:
      'This document changed in another operation. Refresh and try again.',
    enterpriseKnowledgeSelectionUnavailable: 'File selection is currently unavailable.',
    enterpriseKnowledgeErrorInvalidSelection: 'The file selection expired. Select the files again.',
    enterpriseKnowledgeErrorTooManyFiles: 'You can select at most 100 files at a time.',
    enterpriseKnowledgeErrorFileTooLarge: 'The file exceeds the 50 MiB limit.',
    enterpriseKnowledgeErrorUnsupportedType: 'The file format or content is not supported.',
    enterpriseKnowledgeErrorFileChanged: 'The file moved or changed. Select it again.',
    enterpriseKnowledgeErrorQuotaExceeded: 'This workspace has reached the 20 GiB document quota.',
    enterpriseKnowledgeErrorPersistence: 'The knowledge-base operation failed. Try again.',
    enterpriseKnowledgeDocumentsTitle: 'Source documents',
    enterpriseKnowledgeDocumentsSubtitle:
      'Documents uploaded from every entry join this workspace knowledge base and are stored and processed safely on this device.',
    enterpriseKnowledgeFileListTitle: 'File list',
    enterpriseKnowledgeFileCount: '{count} files',
    enterpriseKnowledgeStatusFilter: 'Document status filter',
    enterpriseKnowledgeStatusAll: 'All statuses',
    enterpriseKnowledgeFileSizeUnknown: 'Unknown size',
    enterpriseKnowledgeFileTypeUnknown: 'Unknown type',
    enterpriseKnowledgeUnknownTime: 'Unknown time',
    enterpriseKnowledgeStageQueued: 'Waiting to process',
    enterpriseKnowledgeStageParsing: 'Parsing document',
    enterpriseKnowledgeStageOcr: 'Recognizing text',
    enterpriseKnowledgeStageChunking: 'Preparing content',
    enterpriseKnowledgeStageIndexing: 'Building index',
    enterpriseKnowledgeStageFactExtraction: 'Extracting knowledge',
    enterpriseKnowledgeProgress: 'Progress {progress}%',
    enterpriseKnowledgeProcessingProgress: 'Document processing progress',
    enterpriseKnowledgeLoadingDocuments: 'Loading documents…',
    enterpriseKnowledgeLoadingDetails: 'Loading document details…',
    enterpriseKnowledgeNoDocuments: 'No documents yet. Upload files to process them locally.',
    enterpriseKnowledgeNoDeletedDocuments: 'The trash is empty.',
    enterpriseKnowledgeDocumentDetails: 'Locally extracted content loaded on demand',
    enterpriseKnowledgeCloseDetails: 'Close document details',
    enterpriseKnowledgeDocumentTextEmpty: 'This document has no extracted text to display.',
    enterpriseKnowledgeDeleteConfirm: 'Delete this document?',
    enterpriseKnowledgeDeleteConfirmMessage:
      '“{name}” will move to the trash and can be restored later.',
    enterpriseKnowledgeCancel: 'Cancel',
    enterpriseKnowledgeAiExtraction: 'AI knowledge extraction',
    enterpriseKnowledgeAiExtractionStatusCancelled: 'Cancelled',
    enterpriseKnowledgeAiExtractionStatusCompleted: 'Completed',
    enterpriseKnowledgeAiExtractionStatusFailed: 'Failed',
    enterpriseKnowledgeAiExtractionStatusNotStarted: 'Not started',
    enterpriseKnowledgeAiExtractionStatusQueued: 'Queued',
    enterpriseKnowledgeAiExtractionStatusReviewRequired: 'Review required',
    enterpriseKnowledgeAiExtractionStatusRunning: 'Extracting',
    enterpriseKnowledgeAiExtractionStatusStale: 'Result is stale',
    enterpriseKnowledgeAiExtractionStatusStalePriorVersion: 'A prior version has extracted knowledge',
    enterpriseKnowledgeAiExtractionQueuedDescription: 'Added to the local processing queue',
    enterpriseKnowledgeAiExtractionRunningTitle: 'Extracting AI knowledge',
    enterpriseKnowledgeAiExtractionRunningDescription:
      'Analyzing document content and organizing facts, rules, and selling points',
    enterpriseKnowledgeAiExtractionReviewSummary:
      'Extracted {pendingFactCount} knowledge item(s), awaiting confirmation',
    enterpriseKnowledgeCancelAiExtraction: 'Cancel extraction',
    enterpriseKnowledgeExtractAiKnowledge: 'Extract AI knowledge',
    enterpriseKnowledgeExtractCurrentVersion: 'Extract current version',
    enterpriseKnowledgeExtractionAuthorizationDescription: 'This sends document content to the selected AI service for knowledge extraction. Review the scope before sending.',
    enterpriseKnowledgeExtractionAuthorizationDocument: 'Document',
    enterpriseKnowledgeExtractionAuthorizationExpiresAt: 'Authorization expires',
    enterpriseKnowledgeExtractionAuthorizationModel: 'Model',
    enterpriseKnowledgeExtractionAuthorizationPartialWarning: 'This request may process only part of the content. Review it before sending.',
    enterpriseKnowledgeExtractionAuthorizationPlannedCalls: 'Planned calls',
    enterpriseKnowledgeExtractionAuthorizationPreparing: 'Preparing extraction authorization…',
    enterpriseKnowledgeExtractionAuthorizationProvider: 'Provider',
    enterpriseKnowledgeExtractionAuthorizationSend: 'Confirm and send',
    enterpriseKnowledgeExtractionAuthorizationSending: 'Sending…',
    enterpriseKnowledgeExtractionAuthorizationTitle: 'Authorize AI knowledge extraction',
    enterpriseKnowledgeRetryAiExtraction: 'Retry extraction',
    enterpriseAiKnowledgeColumnActions: 'Actions',
    enterpriseAiKnowledgeColumnDomain: 'Category',
    enterpriseAiKnowledgeColumnEvidence: 'Evidence',
    enterpriseAiKnowledgeColumnSource: 'Source',
    enterpriseAiKnowledgeColumnStatus: 'Status',
    enterpriseAiKnowledgeColumnValue: 'Knowledge',
    enterpriseAiKnowledgeContentCollapse: 'Collapse content',
    enterpriseAiKnowledgeContentExpand: 'Expand content',
    enterpriseAiKnowledgeDomainApplicationScenarios: 'Application scenarios',
    enterpriseAiKnowledgeDomainChannelPreferences: 'Channel preferences',
    enterpriseAiKnowledgeDomainCompanySummary: 'Company summary',
    enterpriseAiKnowledgeDomainContactRules: 'Contact rules',
    enterpriseAiKnowledgeDomainMissingInfo: 'Missing information',
    enterpriseAiKnowledgeDomainProductCapabilities: 'Product capabilities',
    enterpriseAiKnowledgeDomainProductList: 'Product list',
    enterpriseAiKnowledgeDomainProhibitedClaims: 'Prohibited claims',
    enterpriseAiKnowledgeDomainSellingPoints: 'Selling points',
    enterpriseAiKnowledgeDomainTargetCustomers: 'Target customers',
    enterpriseAiKnowledgeEmptyActive: 'No active AI knowledge yet.',
    enterpriseAiKnowledgeEmptyHistory: 'No AI knowledge history yet.',
    enterpriseAiKnowledgeEndOfList: 'All knowledge is shown',
    enterpriseAiKnowledgeEvidenceActive: 'Active evidence',
    enterpriseAiKnowledgeEvidenceAny: 'Any evidence',
    enterpriseAiKnowledgeEvidenceFilterLabel: 'Evidence status',
    enterpriseAiKnowledgeEvidenceStale: 'Stale evidence',
    enterpriseAiKnowledgeLegacyNoEvidence: 'No independent evidence',
    enterpriseAiKnowledgeLegacyReadOnly: 'Read-only',
    enterpriseAiKnowledgeLegacySource: 'Company profile',
    enterpriseAiKnowledgeLoadFailed: 'Failed to load AI knowledge.',
    enterpriseAiKnowledgeLoadMore: 'Load more',
    enterpriseAiKnowledgeLoading: 'Loading AI knowledge…',
    enterpriseAiKnowledgeLoadingMore: 'Loading more…',
    enterpriseAiKnowledgeLoadingStatus: 'AI knowledge loading status',
    enterpriseAiKnowledgeMaintainCompany: 'Maintain company profile',
    enterpriseAiKnowledgePartialLoadFailed: 'Some knowledge failed to load. Current results remain available.',
    enterpriseAiKnowledgeRetryInitial: 'Reload',
    enterpriseAiKnowledgeRetryPartial: 'Retry failed portion',
    enterpriseAiKnowledgeReviewFilterAll: 'All statuses',
    enterpriseAiKnowledgeReviewFilterLabel: 'Review status',
    enterpriseAiKnowledgeSourceExtracted: 'AI extracted',
    enterpriseAiKnowledgeSourceImported: 'Imported',
    enterpriseAiKnowledgeSourceManual: 'Manual',
    enterpriseAiKnowledgeStatusArchived: 'Archived',
    enterpriseAiKnowledgeStatusConfirmed: 'Confirmed',
    enterpriseAiKnowledgeStatusPending: 'Pending',
    enterpriseAiKnowledgeStatusRejected: 'Rejected',
    enterpriseAiKnowledgeTableCaption: 'AI knowledge list',
    enterpriseAiKnowledgeViewActive: 'Active knowledge',
    enterpriseAiKnowledgeViewHistory: 'History',
    enterpriseAiKnowledgeViewLabel: 'Knowledge view',
    enterpriseAiKnowledgeArchive: 'Archive',
    enterpriseAiKnowledgeArchiveConflictDescription: 'The matching company-profile content has changed. Choose how to handle the current value.',
    enterpriseAiKnowledgeArchiveConflictTitle: 'Archive conflict',
    enterpriseAiKnowledgeArchiveKeepCurrent: 'Keep current profile value',
    enterpriseAiKnowledgeArchiveLedgerlessDescription: 'No verifiable history was found, so only the current company-profile value can be kept.',
    enterpriseAiKnowledgeArchiveRemoveCurrent: 'Remove current value too',
    enterpriseAiKnowledgeCompanyConflictDescription: 'The company profile contains a different value. Confirm to replace it with this knowledge.',
    enterpriseAiKnowledgeCompanyConflictTitle: 'Replace company-profile content',
    enterpriseAiKnowledgeCompanyReplace: 'Replace existing value',
    enterpriseAiKnowledgeConfirm: 'Confirm',
    enterpriseAiKnowledgeConfirmRequiresActiveEvidence: 'Only knowledge with active evidence can be confirmed.',
    enterpriseAiKnowledgeDialogCancel: 'Cancel',
    enterpriseAiKnowledgeEvidenceActiveState: 'Active',
    enterpriseAiKnowledgeEvidenceCollapse: 'Collapse evidence',
    enterpriseAiKnowledgeEvidenceConfidence: 'Confidence',
    enterpriseAiKnowledgeEvidenceDrawerClose: 'Close evidence drawer',
    enterpriseAiKnowledgeEvidenceEmpty: 'No evidence is available.',
    enterpriseAiKnowledgeEvidenceEnd: 'All evidence is shown',
    enterpriseAiKnowledgeEvidenceExpand: 'View evidence',
    enterpriseAiKnowledgeEvidenceLoadFailed: 'Failed to load evidence.',
    enterpriseAiKnowledgeEvidenceLoadMore: 'Load more evidence',
    enterpriseAiKnowledgeEvidenceLoading: 'Loading evidence…',
    enterpriseAiKnowledgeEvidenceLoadingMore: 'Loading more evidence…',
    enterpriseAiKnowledgeEvidenceLoadingStatus: 'Evidence loading status',
    enterpriseAiKnowledgeEvidencePreview: 'Evidence excerpt',
    enterpriseAiKnowledgeEvidenceRetry: 'Retry evidence',
    enterpriseAiKnowledgeEvidenceStaleState: 'Stale',
    enterpriseAiKnowledgeEvidenceStateConflict: 'Evidence changed, so the knowledge list was refreshed.',
    enterpriseAiKnowledgeEvidenceUnknownTime: 'Unknown time',
    enterpriseAiKnowledgeMutationDisabledReason: 'This action is unavailable in the current state.',
    enterpriseAiKnowledgeMutationFailed: 'Action failed. Try again.',
    enterpriseAiKnowledgeMutationLiveStatus: 'AI knowledge action status',
    enterpriseAiKnowledgeMutationStale: 'This knowledge changed. Retry from the latest version.',
    enterpriseAiKnowledgeMutationSubmitting: 'Submitting…',
    enterpriseAiKnowledgeMutationSucceeded: 'Action completed.',
    enterpriseAiKnowledgePanelFocusAnchor: 'AI knowledge list focus position',
    enterpriseAiKnowledgeReject: 'Reject',
    enterpriseAiKnowledgeBatchSelectedCount: '{count} selected',
    enterpriseAiKnowledgeBatchMatchingSelectionSummary: 'All matching results selected',
    enterpriseAiKnowledgeBatchMatchingSelectionHint: 'The final count appears after the task starts.',
    enterpriseAiKnowledgeBatchToggleVisibleLabel: 'Select visible reviewable knowledge',
    enterpriseAiKnowledgeBatchSelectAllMatchingPrompt:
      'The visible page is selected. You can extend this to every item matching the current filters.',
    enterpriseAiKnowledgeBatchSelectAllMatchingAction: 'Select all matching filters',
    enterpriseAiKnowledgeBatchSelectAllPendingAction: 'Select all pending knowledge',
    enterpriseAiKnowledgeBatchConfirmAction: 'Confirm {count} selected',
    enterpriseAiKnowledgeBatchConfirmMatchingAction: 'Confirm all matching results',
    enterpriseAiKnowledgeBatchRejectAction: 'Reject {count} selected',
    enterpriseAiKnowledgeBatchRejectMatchingAction: 'Reject all matching results',
    enterpriseAiKnowledgeBatchArchiveAction: 'Archive {count} selected',
    enterpriseAiKnowledgeBatchArchiveMatchingAction: 'Archive all matching results',
    enterpriseAiKnowledgeBatchClearSelection: 'Clear selection',
    enterpriseAiKnowledgeBatchConfirmTitle: 'Confirm {count} knowledge items',
    enterpriseAiKnowledgeBatchConfirmMatchingTitle: 'Confirm all matching results',
    enterpriseAiKnowledgeBatchConfirmDescription:
      'Only knowledge with still-valid evidence and no conflicts will be processed. Items with invalid evidence, revision changes, or conflicts are skipped.',
    enterpriseAiKnowledgeBatchConfirmMatchingDescription:
      'This task applies to every item matching the current filters. The final count appears after the task starts. Only knowledge with still-valid evidence and no conflicts will be processed.',
    enterpriseAiKnowledgeBatchRejectTitle: 'Reject {count} knowledge items',
    enterpriseAiKnowledgeBatchRejectMatchingTitle: 'Reject all matching results',
    enterpriseAiKnowledgeBatchRejectDescription:
      'Provide one shared reason for this batch. Items already handled by newer changes are called out separately in the result.',
    enterpriseAiKnowledgeBatchRejectMatchingDescription:
      'This task applies to every item matching the current filters. The final count appears after the task starts. Provide one shared reason for this batch.',
    enterpriseAiKnowledgeBatchArchiveTitle: 'Archive {count} knowledge items',
    enterpriseAiKnowledgeBatchArchiveMatchingTitle: 'Archive all matching results',
    enterpriseAiKnowledgeBatchArchiveDescription:
      'Archived knowledge leaves the default review queue, and the result keeps success, skipped, and failed totals.',
    enterpriseAiKnowledgeBatchArchiveMatchingDescription:
      'This task applies to every item matching the current filters. The final count appears after the task starts. Archived knowledge leaves the default review queue, and the result keeps success, skipped, and failed totals.',
    enterpriseAiKnowledgeBatchRejectReasonLabel: 'Shared rejection reason',
    enterpriseAiKnowledgeBatchRejectReasonPlaceholder:
      'Explain why this batch should not enter the trusted knowledge base.',
    enterpriseAiKnowledgeBatchRejectReasonRequired:
      'Enter a non-empty rejection reason before submitting.',
    enterpriseAiKnowledgeBatchRejectReasonTooLong:
      'Keep the shared rejection reason within {max} characters.',
    enterpriseAiKnowledgeBatchSubmitConfirm: 'Confirm these {count}',
    enterpriseAiKnowledgeBatchSubmitConfirmMatching: 'Confirm all matching results',
    enterpriseAiKnowledgeBatchSubmitReject: 'Reject these {count}',
    enterpriseAiKnowledgeBatchSubmitRejectMatching: 'Reject all matching results',
    enterpriseAiKnowledgeBatchSubmitArchive: 'Archive these {count}',
    enterpriseAiKnowledgeBatchSubmitArchiveMatching: 'Archive all matching results',
    enterpriseAiKnowledgeBatchLiveStatus: 'Bulk review status',
    enterpriseAiKnowledgeBatchSubmitting: 'Creating the bulk review task…',
    enterpriseAiKnowledgeBatchQueuedStatus: 'Queued, preparing {processed}/{total}',
    enterpriseAiKnowledgeBatchRunningStatus: 'Processing {processed}/{total}',
    enterpriseAiKnowledgeBatchCompletedTitle: 'Bulk review completed',
    enterpriseAiKnowledgeBatchFailedTitle: 'Bulk review needs attention',
    enterpriseAiKnowledgeBatchSuccessCount: 'Success {count}',
    enterpriseAiKnowledgeBatchSkippedCount: 'Skipped {count}',
    enterpriseAiKnowledgeBatchFailedCount: 'Failed {count}',
    enterpriseAiKnowledgeBatchDetailHeading: 'Sample result details',
    enterpriseAiKnowledgeBatchDetailNoActiveEvidence: 'Skipped because the evidence is no longer active.',
    enterpriseAiKnowledgeBatchDetailRevisionConflict:
      'Skipped because the revision changed; retry from the latest version.',
    enterpriseAiKnowledgeBatchDetailProjectionConflict:
      'Skipped because this knowledge now conflicts with the projected profile.',
    enterpriseAiKnowledgeBatchDetailAlreadyProcessed:
      'This item was already handled by another action.',
    enterpriseAiKnowledgeBatchDetailNotFound: 'The knowledge item could not be found.',
    enterpriseAiKnowledgeBatchDetailUnknownError: 'Processing failed and can be retried later.',
    enterpriseAiKnowledgeBatchRetryFailed: 'Retry retryable items ({count})',
    enterpriseAiKnowledgeBatchDismissResult: 'Close result',
    ...
    enterpriseLeadKnowledgeDocumentMetric: 'Source documents',
    enterpriseLeadKnowledgeAiKnowledgeMetric: 'AI extracted knowledge',
    enterpriseLeadKnowledgePendingMetric: 'Pending review',
    enterpriseLeadKnowledgeConfirmedMetric: 'Confirmed',
    enterpriseLeadKnowledgeDocumentLibraryTitle: 'Source documents',
    enterpriseLeadKnowledgeAiKnowledgeTitle: 'AI knowledge',
    enterpriseLeadKnowledgeDocumentLibrarySubtitle:
      'Manage original materials in one place. Files are processed locally before any separate AI knowledge extraction.',
    enterpriseLeadKnowledgeAiKnowledgeSubtitle:
    ...
    enterpriseLeadKnowledgeKnowledgeSearchPlaceholder: 'Search knowledge and categories',
    ...
    enterpriseLeadCreationRunStatusAwaitingApproval: 'Awaiting approval',
    enterpriseLeadCreationRunStatusBlocked: 'Blocked',
    enterpriseLeadCreationRunStatusCompleted: 'Completed',
    enterpriseLeadCreationRunStatusCancelled: 'Cancelled',
