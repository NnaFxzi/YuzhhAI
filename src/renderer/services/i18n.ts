...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    enterpriseLeadWorkspaceNavKits: '专家套件',
    enterpriseLeadWorkbenchNavSettings: '空间技能',
    enterpriseLeadWorkspaceKitsTitle: '专家套件',
    enterpriseLeadWorkspaceKitsDescription: '选择此工作空间默认启用的专家套件。',
    enterpriseLeadWorkspaceKitsSelected: '已选择',
    enterpriseLeadWorkspaceKitsDefault: '默认',
    enterpriseLeadWorkspaceKitsEmptyTitle: '尚未安装专家套件',
    enterpriseLeadWorkspaceKitsEmptyDescription:
      '前往专家套件中心安装套件，然后在这里选择工作空间默认项。',
    enterpriseLeadWorkspaceKitsMissing: '套件未安装',
    enterpriseLeadWorkspaceKitsMissingDescription:
      '此工作空间保存的默认套件在本机不可用，请前往专家套件中心安装或管理。',
    enterpriseLeadWorkspaceKitsMetadataUnavailable: '已安装套件的市场信息暂不可用。',
    enterpriseLeadWorkspaceKitsSaveFailed: '保存专家套件设置失败，请稍后重试。',
    enterpriseLeadWorkspaceKitsManageAction: '安装或管理套件',
    ...
    enterpriseLeadWorkspaceSettingsQuickDesc: '管理当前工作空间对话可调用的技能。',
    ...
    enterpriseLeadWorkspaceQuickSaveDockDesc: '保存后，这些技能将用于当前工作空间中的对话。',
  ...
  en: {
    ...
    newChat: 'New Task',
    workbench: 'Workbench',
    enterpriseLeadNavLabel: 'Workspace',
    ...
    enterpriseLeadWorkspaceNavKits: 'Expert Kits',
    enterpriseLeadWorkbenchNavSettings: 'Workspace skills',
    enterpriseLeadWorkspaceKitsTitle: 'Expert Kits',
    enterpriseLeadWorkspaceKitsDescription:
      'Choose the Expert Kits enabled by default for this workspace.',
    enterpriseLeadWorkspaceKitsSelected: 'Selected',
    enterpriseLeadWorkspaceKitsDefault: 'Default',
    enterpriseLeadWorkspaceKitsEmptyTitle: 'No Expert Kits installed',
    enterpriseLeadWorkspaceKitsEmptyDescription:
      'Install a Kit in the Expert Kits center, then choose workspace defaults here.',
    enterpriseLeadWorkspaceKitsMissing: 'Kit not installed',
    enterpriseLeadWorkspaceKitsMissingDescription:
      'A saved default Kit is unavailable locally. Install or manage it in the Expert Kits center.',
    enterpriseLeadWorkspaceKitsMetadataUnavailable:
      'Marketplace information is unavailable for this installed Kit.',
    enterpriseLeadWorkspaceKitsSaveFailed: 'Failed to save Expert Kit settings. Try again.',
    enterpriseLeadWorkspaceKitsManageAction: 'Install or manage Kits',
    ...
    enterpriseLeadWorkspaceSettingsQuickDesc:
      'Manage the skills available to conversations in this workspace.',
    ...
    enterpriseLeadWorkspaceQuickSaveDockDesc:
      'After saving, these skills are available to conversations in this workspace.',
