...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    enterpriseKnowledgeDocumentsTitle: '本地文档库',
    enterpriseKnowledgeDocumentsSubtitle:
      '文档会复制到当前设备并在本地处理；列表不会暴露原始文件路径。',
  ...
  en: {
    ...
    enterpriseKnowledgeImportPartialSuccess:
      'Imported {imported} document(s); {failed} failed',
    ...
    enterpriseKnowledgeErrorQuotaExceeded:
      'This workspace has reached the 20 GiB document quota.',
    enterpriseKnowledgeErrorPersistence: 'The knowledge-base operation failed. Try again.',
    enterpriseKnowledgeDocumentsTitle: 'Local document library',
    enterpriseKnowledgeDocumentsSubtitle:
      'Documents are copied to this device and processed locally; original file paths stay hidden.',
