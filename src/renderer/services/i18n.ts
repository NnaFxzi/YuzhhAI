...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    enterpriseLeadAgentResponsibility: '职责',
    enterpriseLeadAgentInput: '输入',
    enterpriseLeadAgentOutput: '输出',
    enterpriseLeadAgentChat: '单独沟通',
    enterpriseLeadAgentRun: '运行',
    enterpriseLeadAgentRerun: '重新运行',
    enterpriseLeadAgentRunning: '运行中...',
    enterpriseLeadAgentStale: '上游内容已更新，这个 Agent 的结果可能过期，建议重新运行。',
    ...
    enterpriseLeadAgentChatTitle: '与单个 Agent 沟通',
    enterpriseLeadAgentChatPlaceholder: '告诉这个 Agent 需要调整什么。生成后会作为待确认版本出现，不会自动覆盖。',
    enterpriseLeadAgentGenerateVersion: '生成待确认版本',
    enterpriseLeadPendingVersions: '待确认版本',
    enterpriseLeadNoPendingVersions: '暂无待确认版本。',
    enterpriseLeadApplyVersion: '应用版本',
    enterpriseLeadApplyingVersion: '应用中...',
    enterpriseLeadHumanTodos: '人工待办',
    enterpriseLeadNoTodos: '暂无人工待办。',
    enterpriseLeadDeliverables: '成果包',
    enterpriseLeadNoDeliverables: '暂无成果输出。',
    enterpriseLeadArchives: '归档记录',
    enterpriseLeadNoArchives: '暂无归档记录。',
    enterpriseLeadSafetyBoundary: '安全边界',
    enterpriseLeadSafetyNoPublish: '不会自动发布内容',
    enterpriseLeadSafetyNoComment: '不会自动发表评论',
    enterpriseLeadSafetyNoPrivateMessage: '不会自动发送私信',
    enterpriseLeadSafetyNoEmail: '不会自动发送邮件',
    enterpriseLeadSafetyDraftOnly: '仅保留为草稿、待办或需审批事项',
    enterpriseLeadRunWorkflow: '交给总控运行',
    enterpriseLeadArchiveRun: '归档本次任务',
    enterpriseLeadArchived: '已归档',
    enterpriseLeadRunFailed: 'Agent 任务处理失败，请稍后重试。',
    enterpriseLeadChatFailed: '生成待确认版本失败，请稍后重试。',
    enterpriseLeadApplyVersionFailed: '应用待确认版本失败，请稍后重试。',
    enterpriseLeadArchiveFailed: '归档任务失败，请稍后重试。',
    ...
    enterpriseLeadWorkbenchNavAgentManagement: '代理管理',
    ...
    enterpriseLeadWorkspaceSearchDescription: '搜索当前空间的画像、来源和 Agent 配置。',
    enterpriseLeadWorkspaceSearchInputLabel: '搜索当前空间',
    enterpriseLeadWorkspaceSearchPlaceholder: '搜索产品、客户、来源、规则或 Agent',
    enterpriseLeadWorkspaceSearchResultCount: '{count} 条结果',
    enterpriseLeadWorkspaceSearchScope: '范围：当前空间',
    ...
    enterpriseLeadAiChatEmptyTitle: '接下来要完成什么？',
    enterpriseLeadAiChatSubtitle: '直接输入目标，系统会按本空间 Agent、知识库和调研能力处理。',
    ...
    enterpriseLeadAiChatAgentAll: '全部 / 通用助手',
    ...
    enterpriseLeadCreationRecordDetailLoadFailed: '创作记录详情加载失败，请稍后重试。',
    enterpriseLeadCreationRecordsEmpty: '暂无创作记录。',
    enterpriseLeadCreationRecordSelectEmpty: '选择左侧记录查看详情。',
    ...
    enterpriseLeadWorkbenchModeAgents: 'Agent 管理',
    enterpriseLeadWorkbenchAgentManagementTitle: '工作区 Agent 管理',
    enterpriseLeadWorkbenchAgentManagementDesc: '管理当前工作空间自己的执行 Agent；名称、职责、提示词、模型和技能只在本空间生效。',
    enterpriseLeadWorkbenchAgentCount: '9 个 Agent',
    enterpriseLeadWorkbenchWorkspaceAgentCount: '{count} 个工作区 Agent',
    enterpriseLeadWorkbenchAgentScopeNotice: '仅当前空间生效：编辑 Agent 不会影响其他工作空间。',
    ...
    enterpriseLeadWorkbenchCreateAgentSkillIds: '技能 ID（逗号分隔）',
    ...
    enterpriseLeadWorkbenchOverrideSkillIds: 'Agent 技能 ID（逗号分隔）',
  ...
  en: {
    ...
    enterpriseLeadAgentResponsibility: 'Responsibility',
    enterpriseLeadAgentInput: 'Input',
    enterpriseLeadAgentOutput: 'Output',
    enterpriseLeadAgentChat: 'Individual chat',
    enterpriseLeadAgentRun: 'Run',
    enterpriseLeadAgentRerun: 'Rerun',
    enterpriseLeadAgentRunning: 'Running...',
    enterpriseLeadAgentStale: 'Upstream content changed. This Agent result may be out of date, so rerun is recommended.',
    ...
    enterpriseLeadAgentChatTitle: 'Chat with one Agent',
    enterpriseLeadAgentChatPlaceholder: 'Tell this Agent what to adjust. The result will appear as a pending version and will not overwrite automatically.',
    enterpriseLeadAgentGenerateVersion: 'Generate pending version',
    enterpriseLeadPendingVersions: 'Pending versions',
    enterpriseLeadNoPendingVersions: 'No pending versions yet.',
    enterpriseLeadApplyVersion: 'Apply version',
    enterpriseLeadApplyingVersion: 'Applying...',
    enterpriseLeadHumanTodos: 'Human todos',
    enterpriseLeadNoTodos: 'No human todos yet.',
    enterpriseLeadDeliverables: 'Deliverables',
    enterpriseLeadNoDeliverables: 'No deliverables yet.',
    enterpriseLeadArchives: 'Archives',
    enterpriseLeadNoArchives: 'No archives yet.',
    enterpriseLeadSafetyBoundary: 'Safety boundary',
    enterpriseLeadSafetyNoPublish: 'No automatic publishing',
    enterpriseLeadSafetyNoComment: 'No automatic commenting',
    enterpriseLeadSafetyNoPrivateMessage: 'No automatic private messages',
    enterpriseLeadSafetyNoEmail: 'No automatic email sending',
    enterpriseLeadSafetyDraftOnly: 'Drafts, todos, or approval items only',
    enterpriseLeadRunWorkflow: 'Run with controller',
    enterpriseLeadArchiveRun: 'Archive this run',
    enterpriseLeadArchived: 'Archived',
    enterpriseLeadRunFailed: 'Agent task processing failed. Try again later.',
    enterpriseLeadChatFailed: 'Failed to generate a pending version. Try again later.',
    enterpriseLeadApplyVersionFailed: 'Failed to apply the pending version. Try again later.',
    enterpriseLeadArchiveFailed: 'Failed to archive the run. Try again later.',
    ...
    enterpriseLeadWorkbenchNavAgentManagement: 'Agent management',
    ...
    enterpriseLeadWorkspaceSearchDescription: 'Search this workspace profile, sources, and Agent configuration.',
    enterpriseLeadWorkspaceSearchInputLabel: 'Search current workspace',
    enterpriseLeadWorkspaceSearchPlaceholder: 'Search products, customers, sources, rules, or Agents',
    enterpriseLeadWorkspaceSearchResultCount: '{count} results',
    enterpriseLeadWorkspaceSearchScope: 'Scope: current workspace',
    ...
    enterpriseLeadAiChatEmptyTitle: 'What should we get done next?',
    enterpriseLeadAiChatSubtitle: 'Enter a goal directly. The workspace will use its Agents, knowledge base, and configured research abilities.',
    ...
    enterpriseLeadAiChatAgentAll: 'All / general assistant',
    ...
    enterpriseLeadCreationRecordDetailLoadFailed: 'Failed to load record details. Try again later.',
    enterpriseLeadCreationRecordsEmpty: 'No creation records yet.',
    enterpriseLeadCreationRecordSelectEmpty: 'Select a record on the left to view details.',
    ...
    enterpriseLeadWorkbenchModeAgents: 'Agent management',
    enterpriseLeadWorkbenchAgentManagementTitle: 'Workspace Agent management',
    enterpriseLeadWorkbenchAgentManagementDesc: 'Manage executable Agents owned by this workspace. Names, responsibilities, prompts, models, and skills apply only here.',
    enterpriseLeadWorkbenchAgentCount: '9 Agents',
    enterpriseLeadWorkbenchWorkspaceAgentCount: '{count} workspace Agents',
    enterpriseLeadWorkbenchAgentScopeNotice: 'Only applies to this workspace: editing an Agent will not affect other workspaces.',
    ...
    enterpriseLeadWorkbenchCreateAgentSkillIds: 'Skill IDs (comma-separated)',
    ...
    enterpriseLeadWorkbenchOverrideSkillIds: 'Agent skill IDs (comma-separated)',
